	...
	return (
		<Card mb={{ base: '0px', '2xl': '20px' }} {...rest}>
			...
			<Text color={textColorSecondary} fontSize='md' me='26px' mb='40px'>
				User in Lab Examination System.
			</Text>
			<SimpleGrid columns={2} gap='20px'>
				...
				<Information boxShadow={cardShadow} title='Organization' value='M/s Kriaa Systems' />
				<Information boxShadow={cardShadow} title='Birthday' value='' />
			</SimpleGrid>
		</Card>
	);
}
